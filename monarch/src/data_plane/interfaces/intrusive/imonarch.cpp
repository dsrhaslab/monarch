...
ssize_t IMonarch::read(const std::string &filename, char* result, off_t offset, size_t n){
    return data_plane->read(filename, result, offset, n);
}

ssize_t IMonarch::read_from_id(int file_id, char* result, off_t offset, size_t n){
