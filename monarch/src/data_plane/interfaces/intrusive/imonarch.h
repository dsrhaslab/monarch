...
#ifndef MONARCHH_IMONARCH_H
#define MONARCHH_IMONARCH_H

#include <mutex>
#include "../../logic/stage/stage.h"
...
public:
    ...
    ssize_t read(const std::string &filename, char* result, off_t offset, size_t n);
    size_t get_file_size(const std::string &filename);
    size_t get_file_size_from_id(int id);
    int get_target_class(const std::string &filename);
    ssize_t read_from_id(int file_id, char* result, off_t offset, size_t n);
