...
#ifndef MONARCH_POSIX_FILE_SYSTEM_H
#define MONARCH_POSIX_FILE_SYSTEM_H

#include "transparent_posix_interface.h"

TransparentPosixInterface interface {};
...
#endif //MONARCH_POSIX_FILE_SYSTEM_H
