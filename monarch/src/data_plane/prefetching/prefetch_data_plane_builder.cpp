...
PrefetchDataPlaneBuilder& PrefetchDataPlaneBuilder::with_control_policy(ControlPolicy cp){
    control_policy = cp;
    data_plane->control_policy = cp;
    return *this;
}
...
PrefetchDataPlaneBuilder& PrefetchDataPlaneBuilder::with_placement_policy(PlacementPolicy pp){
    placement_policy = pp;
    data_plane->placement_policy = pp;
    return *this;
}

PrefetchDataPlaneBuilder& PrefetchDataPlaneBuilder::with_evict_call_type(EvictCallType ect){
    evict_call_type = ect;
    return *this;
}
