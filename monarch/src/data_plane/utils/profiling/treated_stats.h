...
#ifndef MONARCH_TREATED_STATS_H
#define MONARCH_TREATED_STATS_H
...
struct TreatedStats {
    ...
    void add_treated_stats(TreatedStats& ts, off_t n_treatments){
...
struct TreatedClientStats {
    ...
    void add_treated_stats(TreatedClientStats& tcs, off_t n_treatments) {
...
struct TreatedPlacementStats {
    ...
    void add_treated_stats(TreatedPlacementStats& tps, off_t n_treatments){
...
struct TreatedStorageStats {
    ...
    void add_treated_stats(TreatedStorageStats& tss, off_t n_treatments){
