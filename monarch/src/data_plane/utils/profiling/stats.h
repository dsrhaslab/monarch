...
#ifndef MONARCH_STATS_H
#define MONARCH_STATS_H
...
struct MutexClientStats{
    ...
    std::unordered_map<std::string, std::atomic<off_t>> metadata_requests;
...
struct ClientStats {
    ...
    std::unordered_map<std::string, off_t> metadata_requests;
