...
SingleThreadEvictionHandler::SingleThreadEvictionHandler(HierarchicalDataPlane* data_plane, SingleThreadPlacementHandler* placement_handler)
...
void SingleThreadEvictionHandler::persist_changes(StrictFileInfo* sfi, int from, int to){
    data_plane_->housekeeper_thread_pool->push([this, sfi, from, to](int id) {
