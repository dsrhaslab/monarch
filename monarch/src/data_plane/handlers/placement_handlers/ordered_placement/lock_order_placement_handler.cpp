...
LockOrderPlacementHandler::LockOrderPlacementHandler(HierarchicalDataPlane* data_plane, PlacementPolicy placement_policy) : OrderedPlacementHandler(data_plane, placement_policy) {}

Status LockOrderPlacementHandler::place(PrefetchedFile* f){
