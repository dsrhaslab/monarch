...
MetadataContainer* ConfigurationParser::parseMetadataContainer(YAML::Node dp_configs){
...
ControllerServiceImpl* ConfigurationParser::parse(const std::string& file_path){
